...
export default function DocumentsScreen() {
  ...
  // ── Data fetching handled by useDocuments hook (SWR) ──────────────────────
  ...
  const submitUpload = async () => {
    ...
    try {
      ...
      handleDocRefresh(); // invalidate cache + refetch
    } catch (e) {
  ...
  // useFocusEffect handled by useDocuments hook internally
  ...
  // onRefresh provided by useDocuments hook as handleDocRefresh
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: bg }]} edges={['top', 'left', 'right']}>
      ...
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={refreshing} onRefresh={handleDocRefresh} tintColor='#3B72EE' />}
      ...
      >
        ...
        <View style={{ paddingHorizontal: 14, paddingTop: 20 }}>
          ...
          {loading ? (
            <SkeletonList count={2} type="doc" isDark={isDark} style={{ paddingHorizontal: 0 }} />
          ) : folders.length === 0 ? (
        ...
        <View style={{ paddingHorizontal: 14, paddingTop: 24 }}>
          ...
          {loading ? (
            <SkeletonList count={5} type="doc" isDark={isDark} />
          ) : sortedDocs.length === 0 ? (
