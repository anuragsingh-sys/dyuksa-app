...
export default function NotificationBell() {
  ...
  const handleOpen = () => {
    setOpen(true);
    setActiveTab('all'); // reset to All tab each time panel opens
    // NOTE: do NOT auto-mark as read here — user must tap "Mark all read"
    // so the Unread tab remains useful.
  };
          ...
          <View style={styles.tabsRow}>
            ...
            >
              ...
              <View style={[
                ...
                unreadCount > 0 && { backgroundColor: '#EF4444' },
                unreadCount > 0 && activeTab === 'unread' && { backgroundColor: '#EF4444' },
              ]}>
                <Text style={[
                  styles.tabCountText,
